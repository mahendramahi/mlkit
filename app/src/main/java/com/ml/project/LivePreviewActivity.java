...
import com.ml.project.barcodescanning.BarcodeScanningProcessor;
import com.ml.project.custommodel.CustomImageClassifierProcessor;
import com.ml.project.facedetection.FaceDetectionProcessor;
import com.ml.project.imagelabeling.ImageLabelingProcessor;
...
public final class LivePreviewActivity extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (allPermissionsGranted()) {
      createCameraSource(IMAGE_LABEL_DETECTION);
    } else {
